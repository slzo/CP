...
CompUnit: Decl { printf("CompUnit -> Decl\n");
                char type[]="CompUnit"; $$=Make1(type); Relate($$,$1); }
        | FuncDef { printf("CompUnit -> FuncDef\n");
                   char type[]="CompUnit"; $$=Make1(type); Relate($$,$1);}
        | CompUnit Decl { printf("CompUnit -> CompUnit Decl\n");
                         char type[]="CompUnit"; $$=Make1(type); Relate($$,$1); Relate($$,$2); }
        | CompUnit FuncDef { printf("CompUnit -> CompUnit FuncDef\n");
                            char type[]="CompUnit"; $$=Make1(type); Relate($$,$1); Relate($$,$2); }
        ;
Decl: ConstDecl { printf("Decl -> ConstDecl\n");
                 char type[]="Decl"; $$=Make1(type); Relate($$,$1); }
        | VarDecl { printf("Decl -> VarDecl\n");
                   char type[]="Decl"; $$=Make1(type); Relate($$,$1); }
        ;
ConstDecl: CONST INT ConstDef ';' { printf("ConstDecl -> const int ConstDef\n");
                                        char type[]="ConstDecl"; $$=Make1(type); Relate($$,$1); Relate($$,$2); Relate($$,$3); Relate($$,$4); }
            ;
